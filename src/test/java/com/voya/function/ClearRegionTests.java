...
import com.gemstone.gemfire.cache.execute.MockResultSender;
    ...
    
{
    ...
    public void testClearRegion()
    {
        ...
        Assert.assertTrue( resultSender.getResults().size() == regionNames.length && resultSender.getExceptions().isEmpty());
    }
